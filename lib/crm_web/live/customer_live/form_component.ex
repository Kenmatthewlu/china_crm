defmodule CrmWeb.CustomerLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:person_in_charge]} type="text" label="Person in charge" />
        <.input field={@form[:email]} type="text" label="Email" />
        <.input field={@form[:company_address]} type="text" label="Company address" />
        <.input field={@form[:warehouse_address]} type="text" label="Warehouse address" />
